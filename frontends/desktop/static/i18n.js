(() => {
  ...
  const BOOT_I18N = {
  zh: {
    'loading.starting_app': '???? GenericAgent...',
    'loading.start': '?????????????...',
    'loading.venv': '????????...',
    'loading.deps': '??????...',
    'loading.done': '??????',
    'loading.starting': '??????...',
    'setup.title': 'GenericAgent - ??',
    'setup.heading': '????',
    'setup.backend_failed': '???????????????',
    'setup.py_label': 'Python ?????',
    'setup.py_placeholder': 'python / ?????',
    'setup.py_hint': '?? C:/Python312/python.exe ? ~/miniconda3/envs/myenv/bin/python',
    'setup.project_label': '????',
    'setup.project_placeholder': 'GenericAgent ?????',
    'setup.project_hint': '?? frontends/desktop_bridge.py ????',
    'setup.start': '??',
    'setup.err_py': '??? Python ??',
    'setup.err_project': '???????',
    'setup.starting_bridge': '???? bridge...',
    'setup.connected': '???????????...',
    'setup.failed': '?????{error}',
    'setup.limit': '???????{n}?'
  },
